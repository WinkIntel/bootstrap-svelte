...
- Upgrading from 1.x: [2.0 migration guide](https://github.com/WinkIntel/bootstrap-svelte/blob/v2.0.0/MIGRATION.md)
...
Feedback from Svelte developers is very welcome. Useful feedback includes:
