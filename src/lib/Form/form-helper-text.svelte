...
// Inside a Bootstrap field wrapper
<div class="mb-3">
...
<script lang="ts">
    ...
    let { children, class: classValues, elementRef = $bindable(null), ...restOfProps }: Form.HelperTextProps = $props();

    let classes: string = $derived(uniqueClsx('form-text', classValues));
</script>
